...
# SYSTEM MESSAGES
    ...
    'BF': {'name': 'Battery Fail', 'handler': 'system_state_change', 'attr': 'battery', 'status': True},
    'BR': {'name': 'Battery Restore', 'handler': 'system_state_change', 'attr': 'battery', 'status': False},
    ...
    'RO': {'name': 'Ready On', 'handler': 'system_state_change', 'attr': 'ready', 'status': False},
    'NR': {'name': 'Not Ready', 'handler': 'system_state_change', 'attr': 'ready', 'status': True},
    ...
    'ZBF': {'name': 'Zone Battery Fail', 'handler': 'system_state_change', 'attr': 'zonebattery', 'status': True},
    'ZBR': {'name': 'Zone Battery Restore', 'handler': 'system_state_change', 'attr': 'zonebattery', 'status': False},
    'PBF': {'name': 'Pendant Battery Fail', 'handler': 'system_state_change', 'attr': 'pendantbattery', 'status': True},
    'PBR': {'name': 'Pendant Battery Restore', 'handler': 'system_state_change', 'attr': 'pendantbattery', 'status': False},
